...
const messages = JSON.parse(fs.readFileSync("./src/messages.json"))
...
exports.getHelpMessage = () => {
    ...
    helpMessage += "!adp info - décompte du temps restant avant la fin du référendum\n"
    helpMessage += "!adp help - affiche message d'aide"
    return helpMessage
}
